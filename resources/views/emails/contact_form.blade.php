...
<body style="font-family: Arial, sans-serif; background:#f5f0e8; padding:24px; color:#2c2416;">
    <div style="max-width:560px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;border:1px solid #e4ddd0;">
        ...
        <div style="padding:28px;">
            ...
            <p style="white-space:pre-line;line-height:1.6;background:#f9f5ee;padding:14px 16px;border-radius:8px;">{{ $messageBody }}</p>
            <p style="margin-top:24px;font-size:12px;color:#8a8478;">You can reply directly to this email to respond to {{ $senderName }}.</p>
        </div>
    </div>
</body>
</html>
