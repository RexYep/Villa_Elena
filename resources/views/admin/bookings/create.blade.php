...
/* Price Preview */
.price-preview{background:var(--terracotta);border-radius:12px;padding:20px;color:#fff;}
                            ...
                            <div class="two-col">
                                <div class="form-check">
                                    <input type="radio" name="slot" value="day" id="slot_day" class="form-check-input"
                                        {{ old('slot', 'day') === 'day' ? 'checked' : '' }} required>
                                ...
                                <div class="form-check">
                                    <input type="radio" name="slot" value="night" id="slot_night" class="form-check-input"
                                        {{ old('slot') === 'night' ? 'checked' : '' }}>
                                    <label for="slot_night" class="form-check-label">Night (7:00 PM – 6:00 AM)</label>
                                </div>
                            </div>
                            @error('slot')<span class="invalid-feedback d-block">{{ $message }}</span>@enderror
                        </div>
                        <div class="two-col">
                            <div>
...
function updatePreview() {
    ...
    document.getElementById('previewTotal').textContent = '₱' + price.toLocaleString('en-PH', {minimumFractionDigits:2});
}
