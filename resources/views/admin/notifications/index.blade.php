...
@push('styles')
<style>
.notif-card{background:var(--cream);border-radius:14px;border:1px solid var(--border);overflow:hidden;margin-bottom:10px;display:block;text-decoration:none;color:inherit;transition:box-shadow .2s;}
.notif-card:hover{box-shadow:0 4px 16px rgba(44,36,22,.08);}
.notif-card.unread{border-left:3px solid var(--terracotta);}
...
.notif-body{flex:1;}
.notif-title{font-weight:600;font-size:14px;color:var(--text-main);}
...
.unread-dot{width:8px;height:8px;border-radius:50%;background:var(--terracotta);flex-shrink:0;margin-top:6px;}
