...
@section('topbar-right')
    <a href="{{ route('admin.users.index') }}" class="text-muted-theme" style="display:flex;align-items:center;gap:6px;text-decoration:none;font-size:13px;border:1px solid var(--border);padding:7px 14px;border-radius:9px;background:#fff;">
...
.profile-hero{background:var(--terracotta);padding:28px 24px;text-align:center;}
.profile-avatar{width:72px;height:72px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:28px;font-weight:700;margin:0 auto 12px;border:3px solid rgba(255,255,255,0.25);background:rgba(255,255,255,0.15);color:#fff;}
.profile-name{font-family:'Cormorant Garamond',serif;color:#fff;font-size:20px;font-weight:700;}
.profile-email{color:rgba(255,255,255,0.65);font-size:12px;margin-top:3px;}

/* Role badges — semantic, unchanged */
.role-badge{margin-top:8px;}
.role-admin    {background:var(--tag-amber-bg);color:var(--tag-amber-fg);}
.role-staff    {background:var(--tag-blue-bg);color:var(--tag-blue-fg);}
.role-customer {background:var(--tag-purple-bg);color:var(--tag-purple-fg);}

/* Stat Cards */
.stats-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px;padding:16px;}
.mini-stat{background:var(--sand);border-radius:10px;padding:14px;text-align:center;}
...
/* Info rows */
.info-row{display:flex;align-items:flex-start;gap:10px;padding:10px 0;border-bottom:1px solid var(--border);font-size:13px;}
.info-row:last-child{border-bottom:none;}
.info-row .info-icon{width:28px;height:28px;border-radius:7px;background:var(--sand);display:flex;align-items:center;justify-content:center;font-size:13px;flex-shrink:0;margin-top:1px;}
...
.btn-edit{background:var(--terracotta);color:#fff;}
                ...
                <div class="profile-hero">
                    ...
                    @if(!$user->status)
                        <div style="margin-top:8px;">
                            <span class="tag-red" style="padding:3px 10px;border-radius:20px;font-size:11px;font-weight:600;">Inactive</span>
                        </div>
                    @endif
                </div>
