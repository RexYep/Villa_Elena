...
.upload-zone i{font-size:28px;color:var(--muted);display:block;margin-bottom:6px;}
...
@media (max-width: 560px) {
    ...
    .existing-images{grid-template-columns:1fr;}
}
</style>
@endpush
                ...
                <div class="form-card">
                    ...
                    <div class="form-card-body">
                        ...
                        <div class="mb-3">
                            ...
                            @if($existingVilla)
                            <div id="villaWarning" style="display:none;margin-top:8px;padding:10px 12px;background:#fef9c3;border:1px solid #fde68a;border-radius:8px;font-size:12px;color:#a16207;">
                                <i class="bi bi-exclamation-triangle me-1"></i>
                                May ibang master Villa na ("{{ $existingVilla->property_name }}"). Iisang buong-Villa lang ang dapat bookable sa system.
                            </div>
                            @endif
                        </div>
                            ...
                            <div>
                                ...
                                <div class="input-prefix">
                                    ...
                                    <input type="number" name="base_price" class="form-control"
                                        value="{{ old('base_price', $property->base_price) }}" min="0" step="0.01">
                                </div>
                            </div>
                            <div>
                        ...
                        @if($property->images->count() > 0)
                            ...
                            <div class="existing-images" id="existingImages">
                                ...
                                <div class="existing-img-item" data-image-id="{{ $image->id }}">
                                    <img src="{{ $image->url }}" alt="{{ $image->alt_text ?? $property->property_name }}">
                                    @if($image->is_primary)
