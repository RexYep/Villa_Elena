...
.notice-box{background:#f9f5ee;border-radius:10px;padding:14px 16px;font-size:12px;color:var(--muted);line-height:1.6;margin-bottom:16px;}
    ...
    <div class="booking-summary">
        ...
        <div>
            ...
            <div class="summary-dates">
                Currently: {{ $booking->check_in_date->format('M d, Y') }} {{ \Carbon\Carbon::parse($booking->check_in_time)->format('g:i A') }}
                — {{ $booking->check_out_date->format('M d, Y') }} {{ \Carbon\Carbon::parse($booking->check_out_time)->format('g:i A') }}
                · {{ $booking->booking_ref }}
            </div>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('customer.bookings.reschedule.update', $booking) }}">
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                @error('dates')<div class="field-error" style="margin-bottom:12px;">{{ $message }}</div>@enderror
