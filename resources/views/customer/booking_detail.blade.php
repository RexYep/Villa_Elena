...
@media (max-width:600px){
    .booking-hero{justify-content:center;text-align:center;}
    .hero-arrow{display:none;}
    .pay-table{display:block;overflow-x:auto;white-space:nowrap;}
}
</style>
@endpush
    ...
    <div class="detail-grid">
        ...
        <div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-muted-theme" style="margin-top:12px;background:#f9f5ee;border-radius:8px;padding:12px;font-size:13px;">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    @if($booking->payments->isEmpty())
                        <p class="text-muted-theme" style="font-size:13px;text-align:center;padding:16px 0;">No payments recorded yet.</p>
                    @else
                        <table class="pay-table">
                            <thead><tr>
                                <th>Date</th><th>Method</th><th>Type</th><th class="text-end">Amount</th>
                            </tr></thead>
                            <tbody>
        ...
        <div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="price-row"><span class="text-muted-theme">Base ({{ $booking->num_nights }}n)</span><span>₱{{ number_format($booking->base_amount,2) }}</span></div>
                    @if($booking->extras_amount > 0)
                    <div class="price-row"><span class="text-muted-theme">Add-ons</span><span>₱{{ number_format($booking->extras_amount,2) }}</span></div>
                    @endif
