...
a.notif-card{display:block;text-decoration:none;color:inherit;cursor:pointer;}
a.notif-card:hover{box-shadow:0 4px 16px rgba(44,36,22,.08);}
</style>
@endpush
...
@section('content')
    ...
    @endphp
   <a href="{{ route('customer.notifications.open', $notif) }}" class="notif-card {{ !$notif->is_read ? 'unread' : '' }}">
