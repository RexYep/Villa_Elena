...
@section('title', 'Booking Confirmed — Villa Elena Resort')
@section('bare')@endsection
@section('no-chatbot')@endsection
...
@push('styles')
    <style>
        ...
        .confirm-card {
            ...
            width: 100%;
            overflow: hidden;
            box-shadow: 0 20px 60px rgba(44, 36, 22, .1);
        }
        ...
        .card-top::before {
            ...
            height: 300px;
            border-radius: 50%;
            background: radial-gradient(circle, rgba(184, 148, 63, .2) 0%, transparent 65%);
            top: 50%;
            left: 50%;
    ...
    <div class="confirm-card">
        ...
        <div class="confirm-card-body">
            ...
            <div class="detail-row">
                ...
                <span class="val"
                    style="font-family:'Playfair Display',serif;font-size:17px;">₱{{ number_format($booking->total_amount, 2) }}</span>
            </div>
            <div class="detail-row">
            ...
            <div class="deposit-notice">
                ...
                <div class="deposit-notice-text">
                    <strong>Payment not collected yet.</strong> Our team will contact you at
                    <strong>{{ Auth::user()->email }}</strong> within 24 hours to arrange your deposit payment and confirm
                    your booking.
                </div>
            </div>
            ...
            <div class="next-steps">
                ...
                <div class="next-step">
                    <div class="step-num">1</div><span>Our team reviews your booking request</span>
                </div>
                <div class="next-step">
                    <div class="step-num">2</div><span>We contact you to arrange the deposit payment</span>
                </div>
                <div class="next-step">
                    <div class="step-num">3</div><span>Booking is confirmed once deposit is received</span>
                </div>
                <div class="next-step">
                    <div class="step-num">4</div><span>Enjoy your stay at Villa Elena Resort!</span>
                </div>
            </div>
