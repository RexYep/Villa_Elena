...
.confirm-card{background:#fff;border-radius:24px;border:1px solid var(--border);max-width:560px;width:100%;overflow:hidden;box-shadow:0 20px 60px rgba(44,36,22,.1);}
...
@media (max-width: 480px) {
    ...
    .card-top{padding:28px 20px;}
    .confirm-card-body{padding:24px 20px;}
...
<div class="confirm-card">
    ...
    <div class="confirm-card-body">
        ...
        <div class="detail-row">
            ...
            <span class="val"><span class="tag-amber" style="padding:3px 10px;border-radius:20px;font-size:11px;font-weight:700;">Pending Confirmation</span></span>
        </div>
