...
<head>
    ...
    <title>{{ $resortName }} — Private Island Luxury</title>
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@400;500;600;700;900&family=Inter:wght@300;400;500;600&display=swap" rel="stylesheet">
    ...
    z-index: 1;
        ...
        .search-input:focus {
            ...
            box-shadow: 0 0 0 4px rgba(184,148,63,0.15);
        }
        .search-input::placeholder { color: rgba(255,255,255,0.4); }
        .search-input option { background: var(--stone); }
...
<nav class="nav" id="mainNav">
    <div class="nav-inner">
        ...
        <ul class="nav-links">
            ...
            <li><a href="#properties">Rooms</a></li>
        ...
        <div class="nav-right">
            ...
            @else
                ...
                <a href="{{ route('register') }}" class="nav-btn nav-btn-gold">Join Now</a>
            @endauth
        </div>
...
<div class="mobile-menu" id="mobileMenu">
    ...
    <a href="#properties" class="mobile-link">Rooms & Villas</a>
    ...
    <div class="mobile-auth">
        @auth
            <a href="{{ route('customer.home') }}" class="nav-btn nav-btn-ghost" style="text-align:center;">My Bookings</a>
        @else
            <a href="{{ route('login') }}" class="nav-btn nav-btn-ghost" style="text-align:center;">Sign In</a>
            <a href="{{ route('register') }}" class="nav-btn nav-btn-gold" style="text-align:center;">Join Now</a>
        @endauth
    </div>
</div>
...
<section class="hero" id="hero">
    ...
    <div class="hero-content">
        <div class="hero-eyebrow">Private Luxury Resort • Calamba</div>
        ...
        <form method="GET" action="{{ route('home') }}" id="searchForm">
            <div class="search-box">
                ...
                <div class="search-field" style="min-width:130px;">
                    ...
                    <input type="number" name="guests" class="search-input"
                           value="{{ request('guests', 2) }}" min="1" max="30">
                </div>
                <div class="search-field" style="min-width:150px;">
                    <label class="search-label">Villa Type</label>
                ...
                <button type="submit" class="btn-search">
                    <i class="bi bi-search"></i> Find Availability
                </button>
            </div>
        </form>
    </div>
...
<section id="properties">
    <div class="section">
        <div class="section-header">
            <div>
                <div class="section-eyebrow reveal">Our Exclusive Collection</div>
                <div class="section-title reveal reveal-delay-1">Signature Villas</div>
                <p class="section-desc reveal reveal-delay-2">Each villa is a private world of its own — crafted with local materials and designed for complete immersion in nature.</p>
            </div>
            <div class="results-count reveal">
                {{ $properties->count() }} {{ $properties->count() === 1 ? 'villa' : 'villas' }} available
            </div>
        </div>

        {{-- Active Filters --}}
        @if(request()->hasAny(['checkin','checkout','guests','type']) && request()->filled('checkin'))
            <div style="background:rgba(184,148,63,0.08);border:1px solid rgba(184,148,63,0.2);border-radius:16px;padding:14px 20px;margin-bottom:40px;display:flex;align-items:center;gap:12px;font-size:14px;flex-wrap:wrap;">
                ...
                @if(request('checkin') && request('checkout'))
                    <strong>{{ \Carbon\Carbon::parse(request('checkin'))->format('M j') }} – {{ \Carbon\Carbon::parse(request('checkout'))->format('M j, Y') }}</strong>
                @endif
                @if(request('guests')) <span>· {{ request('guests') }} guests</span> @endif
                @if(request('type')) <span>· {{ ucfirst(request('type')) }}</span> @endif
        ...
        @if($properties->isEmpty())
            <div class="empty-state">
                ...
                <p style="font-size:20px;font-weight:500;margin-bottom:12px;color:var(--stone);">No matching villas found</p>
                <p>Try adjusting your dates or filters.</p>
                <a href="{{ route('home') }}" style="color:var(--gold);margin-top:20px;display:inline-block;">Browse all villas →</a>
            </div>
        @else
            <div class="properties-grid">
                ...
                <a href="{{ route('portal.property', $property) }}?checkin={{ $checkin }}&checkout={{ $checkout }}&guests={{ $guests }}"
                   class="property-card reveal">
                    <div class="property-img-wrap">
                        @if($property->primaryImage)
                            <img src="{{ asset('storage/'.$property->primaryImage->image_path) }}" 
                                 class="property-img" alt="{{ $property->property_name }}">
                        @else
                            <div style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;font-size:60px;color:#ddd;">
                                <i class="bi bi-house"></i>
                            </div>
                        @endif
                        <span class="prop-type-badge">{{ ucfirst($property->type) }}</span>
                        <span class="prop-status-badge status-{{ $property->status }}">
                    ...
                    <div class="prop-body">
                        ...
                        <div class="prop-meta">
                            <span><i class="bi bi-people-fill"></i> Max {{ $property->max_capacity }} guests</span>
                            @if($property->floor_area)
                                <span><i class="bi bi-arrows-angle-expand"></i> {{ $property->floor_area }} m²</span>
                            @endif
                        </div>
                        ...
                        <div class="prop-footer">
                            <div>
                                <span class="prop-price-val">₱{{ number_format($property->base_price, 0) }}</span>
                                <span class="prop-price-night">/ night</span>
                            </div>
                            @if($property->status === 'available')
                                <span class="btn-book">
                                    {{ $checkin && $checkout ? 'Reserve Now' : 'View Villa' }}
                                </span>
                            @else
                                <span class="btn-book btn-book-unavailable">Currently Booked</span>
                            @endif
                        </div>
                    </div>
                </a>
...
<section id="gallery">
    ...
    <img src="{{ asset('images/images1.jpeg') }}" alt="Beachfront villas">
    <div class="gallery-overlay"><div class="gallery-caption">Beachfront Villas</div></div>
</div>
            <div class="gallery-item" onclick="openLightbox(this)">
                <img src="{{ asset('images/images2.jpeg') }}" alt="Infinity Pool">
                <div class="gallery-overlay"><div class="gallery-caption">Inside View</div></div>
            </div>
            <div class="gallery-item" onclick="openLightbox(this)">
                <img src="{{ asset('images/images3.jpeg') }}" alt="Villa Interior">
                <div class="gallery-overlay"><div class="gallery-caption">Villa Interior</div></div>
            </div>
            <div class="gallery-item wide" onclick="openLightbox(this)">
                <img src="{{ asset('images/images5.jpeg') }}" alt="Resort View">
                <div class="gallery-overlay"><div class="gallery-caption">Panoramic Resort Pool View</div></div>
            </div>
            <div class="gallery-item" onclick="openLightbox(this)">
                <img src="{{ asset('images/images4.jpeg') }}" alt="Sunset Dining">
                <div class="gallery-overlay"><div class="gallery-caption">Outside View</div></div>
            </div>
            <div class="gallery-item" onclick="openLightbox(this)">
                <img src="{{ asset('images/images6.jpeg') }}" alt="Spa Treatment">
                <div class="gallery-overlay"><div class="gallery-caption">Play Area</div></div>
            </div>
            <div class="gallery-item" onclick="openLightbox(this)">
                <img src="{{ asset('images/images10.jpg') }}" alt="Ocean Activities">
    ...
    <div class="section">
        <div class="about-grid">
            <div class="about-img-stack reveal">
                <img src="{{ asset('images/images12.jpg') }}"
                     class="about-img-main" alt="Resort landscape">
                <img src="{{ asset('images/images16.jpg') }}"
            ...
            <div class="about-text">
                ...
                <p class="reveal reveal-delay-2" style="color:var(--muted);font-size:16px;line-height:1.8;font-weight:300;margin-bottom:18px;">
                ...
                <p class="reveal reveal-delay-3" style="color:var(--muted);font-size:16px;line-height:1.8;font-weight:300;">
...
<section id="testimonials">
    <div class="section">
        <div style="text-align:center;margin-bottom:0;">
            ...
            <p style="color:var(--muted);font-size:16px;max-width:500px;margin:14px auto 0;font-weight:300;line-height:1.7;" class="reveal reveal-delay-2">
        ...
        <div class="testimonials-grid">
            <div class="testimonial-card reveal reveal-delay-1">
                ...
                <p class="testimonial-text">
                    "Absolutely magical. The villa was beyond anything we'd imagined — the private plunge pool, the sunsets, the impeccable service. We're already planning our return."
                </p>
                <div class="testimonial-author">
                    <div class="author-avatar">M</div>
                    <div>
                        <div class="author-name">Maria Santos</div>
                        <div class="author-location">Manila, Philippines</div>
                    </div>
                </div>
            </div>
            ...
            <div class="testimonial-card reveal reveal-delay-2">
                ...
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">
                    "We celebrated our anniversary here and it was the most romantic trip of our lives. The staff remembered every detail — from our dietary needs to a surprise sunset dessert."
                </p>
                <div class="testimonial-author">
                    <div class="author-avatar">J</div>
                    <div>
                        <div class="author-name">James & Chloe Reyes</div>
                        <div class="author-location">Cebu City, Philippines</div>
                    </div>
                </div>
            </div>
            ...
            <div class="testimonial-card reveal reveal-delay-3">
                ...
                <div class="testimonial-stars">★★★★★</div>
                <p class="testimonial-text">
                    "The seamless booking experience was just the beginning. From arrival to departure, every moment at Villa Elena felt curated and deeply personal. Truly world-class."
                </p>
                <div class="testimonial-author">
                    <div class="author-avatar">A</div>
                    <div>
                        <div class="author-name">Ana Lim</div>
            ...
            <div class="location-info">
                <div class="location-item reveal reveal-delay-1">
                    ...
                    <div>
                        ...
                        <div class="location-item-value">Villa Elena Resort<br>Barangay Pansol<br>Calamba,Laguna</div>
            ...
            <div class="contact-info">
                ...
                <div class="contact-item reveal reveal-delay-2">
                    ...
                    <div>
                        ...
                        <div class="contact-item-value">
                            <a href="mailto:hello@villaelena.ph">hello@villaelena.ph</a>
                        </div>
                    </div>
                </div>
                <div class="contact-item reveal reveal-delay-3">
                    ...
                    <div>
                        ...
                        <div class="contact-item-value">
                            <a href="https://wa.me/639171234567" target="_blank">+63 917 123 4567</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="contact-form reveal reveal-delay-2">
                <form method="POST" action="#" id="contactForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="subject" class="form-input" placeholder="Booking inquiry, special request...">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Message</label>
                        <textarea name="message" class="form-input" rows="5" placeholder="Tell us how we can help you plan the perfect getaway..."></textarea>
                    </div>
        ...
        <div class="footer-top">
            ...
            <div>
                ...
                <p class="footer-tagline">
                    A private resort sanctuary where luxury meets the untouched beauty of nature. Barangay Pansol,Calamba,Laguna,Philippines.
                </p>
                <div class="footer-social">
                    ...
                    <a href="#" class="footer-social-link" aria-label="Twitter X"><i class="bi bi-twitter-x"></i></a>
            ...
            <div>
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="mailto:hello@villaelena.ph">hello@villaelena.ph</a></li>
                    <li style="color:rgba(255,255,255,0.4);font-size:14px;line-height:1.6;">Barangay Pansol, Calamba<br>Laguna</li>
                </ul>
            </div>
        </div>
...
<script>
    ...
    document.getElementById('searchForm')?.addEventListener('submit', () => {
        sessionStorage.setItem('scrollToProperties', '1');
    });
