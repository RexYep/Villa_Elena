...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('payment.checkout', $booking) }}" id="payForm">
            ...
            @if($isDepositOnly)
            <div class="section-label" style="font-size:12px;color:#374151;margin-bottom:10px;">Choose Payment Option</div>
            ...
            <div style="background:#fffbeb;border:1px solid #fde68a;border-radius:10px;padding:12px 14px;margin-bottom:14px;font-size:12px;color:#92400e;line-height:1.6;">
                <i class="bi bi-info-circle me-1"></i>
                Dahil sa cancellation history ng account na ito, full payment na lang ang available para sa booking na ito.
            </div>
            <div style="background:var(--sand);border-radius:12px;padding:16px;margin-bottom:20px;text-align:center;">
                <div class="text-muted-theme" style="font-size:11px;text-transform:uppercase;letter-spacing:1px;margin-bottom:6px;">Full Payment Required</div>
                <div style="font-family:'Playfair Display',serif;font-size:28px;font-weight:700;">₱{{ number_format($booking->total_amount,2) }}</div>
            ...
            <div style="background:var(--sand);border-radius:12px;padding:16px;margin-bottom:20px;text-align:center;">
                <div class="text-muted-theme" style="font-size:11px;text-transform:uppercase;letter-spacing:1px;margin-bottom:6px;">Paying Remaining Balance</div>
