...
@section('title', 'Payment Successful — Villa Elena Resort')
...
.status-confirmed{background:var(--tag-green-bg);color:var(--tag-green-fg);padding:3px 10px;border-radius:20px;font-size:11px;font-weight:700;}
.status-partial{background:var(--tag-amber-bg);color:var(--tag-amber-fg);padding:3px 10px;border-radius:20px;font-size:11px;font-weight:700;}
