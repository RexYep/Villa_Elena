...
<style>
    ...
    .chat-header-info .name { color: #fff; font-size: 14px; font-weight: 600; }
    ...
    .qr-btn:hover { background: var(--navy); color: var(--gold); border-color: var(--navy); }
    ...
    .prop-card-name { font-size: 13px; font-weight: 700; color: #0d1b2a; margin-bottom: 2px; }
    .prop-card-meta { font-size: 11px; color: #6b7a8d; margin-bottom: 6px; }
    .prop-card-price { font-size: 13px; color: #0d1b2a; margin-bottom: 8px; }
    .prop-card-price strong { color: #c9a84c; font-size: 15px; }
    .prop-card-amenities { display: flex; gap: 4px; flex-wrap: wrap; margin-bottom: 8px; }
    .amenity-tag {
        background: #f1f5f9; border-radius: 10px;
        padding: 2px 8px; font-size: 10px; color: #475569;
    }
    .prop-card-book {
    ...
    .prop-card-book:hover { background: var(--gold); color: var(--navy); }
    ...
    .chat-input {
        ...
        line-height: 1.4; color: #1a2f45; transition: border-color .2s;
    }
...
<div id="chat-window">
    ...
    <div class="quick-replies" id="quick-replies">
        ...
        <button class="qr-btn" onclick="quickSend('Book a villa for 2 people this weekend')">📅 Book this weekend</button>
    ...
    <div class="chat-messages" id="chat-messages">
        <div class="msg bot">
            ...
            <div class="msg-bubble">
                ...
                I can help you <strong>find available properties</strong>, check prices, and book your stay. Just tell me your dates and how many guests! 🏝️
            </div>
        </div>
    </div>
...
function addMessage(role, text, cards = []) {
    ...
    wrapper.style.cssText = 'display:flex; flex-direction:column; align-items:' + (isUser ? 'flex-end' : 'flex-start') + '; gap:6px; width:100%;';
    ...
    if (cards && cards.length > 0) {
        ...
        cards.forEach(p => {
            const nightsLabel = p.nights > 1
                ? `₱${formatPrice(p.total)} total (${p.nights} nights)`
                : `₱${formatPrice(p.per_night)}/night`;
            ...
            cardsDiv.innerHTML += `
                <div class="prop-card">
                    ...
                    <div class="prop-card-body">
                        ...
                        <div class="prop-card-price"><strong>${nightsLabel}</strong></div>
                        ${amenitiesHtml}
...
function showTyping() {
    const div = document.createElement('div');
    div.className = 'msg bot typing'; div.id = 'typing-indicator';
    div.innerHTML = `<div class="msg-avatar">E</div><div class="msg-bubble"><div class="dot"></div><div class="dot"></div><div class="dot"></div></div>`;
