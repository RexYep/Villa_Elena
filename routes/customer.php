...
Route::prefix('my')
    ...
    Route::put('reviews/{review}',    [CustomerReviewController::class, 'update'])->middleware('throttle:review-write')->name('reviews.update');
    ...
    Route::put('profile/2fa',                 [ProfileController::class, 'toggleTwoFactor'])->middleware('throttle:password-confirm')->name('profile.2fa.toggle');
